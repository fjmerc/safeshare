...
`,
	},
	{
		Version:     7,
		Name:        "007_sso",
		Description: "SSO/OIDC Integration support",
		SQL: `
-- ============================================================================
-- SSO PROVIDERS TABLE
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS sso_providers (
    ...
    auto_provision BOOLEAN NOT NULL DEFAULT FALSE, -- Create users on first SSO login
...
CREATE TABLE IF NOT EXISTS user_sso_links (
    ...
    -- Metadata
    last_login_at TIMESTAMPTZ,                  -- Last successful SSO login
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS sso_states (
    ...
    user_id BIGINT REFERENCES users(id) ON DELETE SET NULL, -- If linking existing account
