...
- Updated `golang.org/x/text` to v0.39.0 and the Go toolchain to 1.25.12, resolving two vulnerabilities reachable from SafeShare: GO-2026-5970 (reached via PDF metadata stripping) and GO-2026-5856, an Encrypted Client Hello privacy leak in the standard library's `crypto/tls`.
