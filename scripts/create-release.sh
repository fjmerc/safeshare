...
if [[ "$CURRENT_BRANCH" != "main" ]]; then
    ...
    echo -e "     ${YELLOW}git checkout -b release/vX.Y.Z develop${NC}"
    echo ""
    ...
    echo -e "     ${YELLOW}git merge --no-ff release/vX.Y.Z${NC}"
    echo ""
    ...
    echo -e "     ${YELLOW}git branch -d release/vX.Y.Z${NC}"
    echo ""
...
echo -e "     ${YELLOW}git push origin main ${NEW_VERSION}${NC}"
echo ""
echo "  2. Merge release branch back to develop:"
echo -e "     ${YELLOW}git checkout develop${NC}"
echo -e "     ${YELLOW}git merge --no-ff release/${NEW_VERSION}${NC}"
echo -e "     ${YELLOW}git push origin develop${NC}"
echo ""
echo "  3. Delete release branch:"
echo -e "     ${YELLOW}git branch -d release/${NEW_VERSION}${NC}"
echo -e "     ${YELLOW}git push origin --delete release/${NEW_VERSION}${NC}"
echo ""
